  ...
  const steps = [
    {
      ...
      icon: (
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#E85D04" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <line x1="12" y1="5" x2="12" y2="19" />
          <line x1="5" y1="12" x2="19" y2="12" />
        </svg>
      ),
  ...
  return (
    <main style={{ fontFamily: "Arial, sans-serif" }}>
      ...
      <section style={{ padding: "5rem 2rem 4rem", textAlign: "center", maxWidth: "720px", margin: "0 auto" }}>
        ...
        <p style={{ fontSize: "18px", color: "#555", lineHeight: "1.6", maxWidth: "560px", margin: "0 auto 2.5rem" }}>
        ...
        <div style={{ display: "flex", gap: "10px", maxWidth: "440px", margin: "0 auto 1rem" }}>
          ...
          />
          <button
            onClick={() => handleSignup(heroEmail, setHeroSuccess, setHeroEmail)}
        ...
        {heroSuccess && (
          <p style={{ fontSize: "14px", color: "#2D6A4F", marginBottom: "8px" }}>You're on the list. We'll be in touch.</p>
        )}
      ...
      <section style={{ background: "#f9f9f9", padding: "4rem 2rem" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          <div style={{ fontSize: "13px", fontWeight: "600", color: "#E85D04", letterSpacing: "1px", textTransform: "uppercase", marginBottom: "0.5rem" }}>
            Core features
          </div>
          <h2 style={{ fontSize: "32px", fontWeight: "700", color: "#1A1A2E", marginBottom: "3rem" }}>
      ...
      <div style={{ background: "#1A1A2E", padding: "3rem 2rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2rem", maxWidth: "700px", margin: "0 auto", textAlign: "center" }}>
          {[
            ["26M+", "basketball players in the US"],
            ["0", "apps built for individual training"],
      ...
      <section style={{ padding: "5rem 2rem", textAlign: "center", maxWidth: "600px", margin: "0 auto" }}>
        <h2 style={{ fontSize: "36px", fontWeight: "700", color: "#1A1A2E", marginBottom: "1rem" }}>
          Your grind deserves a record.
        </h2>
        ...
        <div style={{ display: "flex", gap: "10px", maxWidth: "420px", margin: "0 auto" }}>
          ...
          />
          <button
            onClick={() => handleSignup(ctaEmail, setCtaSuccess, setCtaEmail)}
        ...
        {ctaSuccess && (
          <p style={{ fontSize: "14px", color: "#2D6A4F", marginTop: "8px" }}>You're in. We'll reach out soon.</p>
        )}
      </section>
